...
class HousekeeperCatalogRecords extends Table
    with TableInfo<HousekeeperCatalogRecords, HousekeeperCatalogRecordsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  HousekeeperCatalogRecords(this.attachedDatabase, [this._alias]);
  ...
  @override
  HousekeeperCatalogRecordsData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return HousekeeperCatalogRecordsData(
  ...
  @override
  HousekeeperCatalogRecords createAlias(String alias) {
    return HousekeeperCatalogRecords(attachedDatabase, alias);
  }
...
class HousekeeperCatalogRecordsData extends DataClass
    implements Insertable<HousekeeperCatalogRecordsData> {
  final String id;
  ...
  const HousekeeperCatalogRecordsData({
    required this.id,
  ...
  factory HousekeeperCatalogRecordsData.fromJson(
  ...
  HousekeeperCatalogRecordsData copyWith({
    String? id,
    String? displayName,
    String? paletteKey,
    int? sortOrder,
  ...
  HousekeeperCatalogRecordsData copyWithCompanion(
  ...
  @override
  String toString() {
    return (StringBuffer('HousekeeperCatalogRecordsData(')
          ..write('id: $id, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is HousekeeperCatalogRecordsData &&
          other.id == this.id &&
...
class HousekeeperCatalogRecordsCompanion
    extends UpdateCompanion<HousekeeperCatalogRecordsData> {
  ...
  HousekeeperCatalogRecordsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       sortOrder = Value(sortOrder),
       updatedAt = Value(updatedAt);
  static Insertable<HousekeeperCatalogRecordsData> custom({
...
class AssignmentNoteRecords extends Table
    with TableInfo<AssignmentNoteRecords, AssignmentNoteRecordsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  AssignmentNoteRecords(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> sessionId = GeneratedColumn<String>(
    'session_id',
    aliasedName,
    false,
  ...
  @override
  AssignmentNoteRecordsData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return AssignmentNoteRecordsData(
      sessionId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}session_id'],
      )!,
  ...
  @override
  AssignmentNoteRecords createAlias(String alias) {
    return AssignmentNoteRecords(attachedDatabase, alias);
  }
...
class AssignmentNoteRecordsData extends DataClass
    implements Insertable<AssignmentNoteRecordsData> {
  final String sessionId;
  final String assignmentId;
  final String textValue;
  ...
  const AssignmentNoteRecordsData({
    required this.sessionId,
    required this.assignmentId,
    required this.textValue,
  ...
  factory AssignmentNoteRecordsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  AssignmentNoteRecordsData copyWith({
    String? sessionId,
    String? assignmentId,
    String? textValue,
    int? updatedAtMicros,
  ...
  AssignmentNoteRecordsData copyWithCompanion(
    AssignmentNoteRecordsCompanion data,
  ) {
    return AssignmentNoteRecordsData(
      sessionId: data.sessionId.present ? data.sessionId.value : this.sessionId,
      assignmentId: data.assignmentId.present
  ...
  @override
  String toString() {
    return (StringBuffer('AssignmentNoteRecordsData(')
          ..write('sessionId: $sessionId, ')
          ..write('assignmentId: $assignmentId, ')
          ..write('textValue: $textValue, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is AssignmentNoteRecordsData &&
          other.sessionId == this.sessionId &&
          other.assignmentId == this.assignmentId &&
          other.textValue == this.textValue &&
...
class AssignmentNoteRecordsCompanion
    extends UpdateCompanion<AssignmentNoteRecordsData> {
  final Value<String> sessionId;
  final Value<String> assignmentId;
  final Value<String> textValue;
  ...
  AssignmentNoteRecordsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       textValue = Value(textValue),
       updatedAtMicros = Value(updatedAtMicros);
  static Insertable<AssignmentNoteRecordsData> custom({
    Expression<String>? sessionId,
    Expression<String>? assignmentId,
    Expression<String>? textValue,
...
class CartConsumableRecords extends Table
    with TableInfo<CartConsumableRecords, CartConsumableRecordsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  CartConsumableRecords(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> sessionId = GeneratedColumn<String>(
    'session_id',
    aliasedName,
    false,
  ...
  @override
  CartConsumableRecordsData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return CartConsumableRecordsData(
      sessionId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}session_id'],
      )!,
  ...
  @override
  CartConsumableRecords createAlias(String alias) {
    return CartConsumableRecords(attachedDatabase, alias);
  }
...
class CartConsumableRecordsData extends DataClass
    implements Insertable<CartConsumableRecordsData> {
  final String sessionId;
  final String assignmentId;
  final String itemId;
  final String title;
  ...
  final int? deletedAtMicros;
  const CartConsumableRecordsData({
    required this.sessionId,
    required this.assignmentId,
  ...
  factory CartConsumableRecordsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  CartConsumableRecordsData copyWith({
    String? sessionId,
    String? assignmentId,
    String? itemId,
    String? title,
  ...
  CartConsumableRecordsData copyWithCompanion(
    CartConsumableRecordsCompanion data,
  ) {
    return CartConsumableRecordsData(
      sessionId: data.sessionId.present ? data.sessionId.value : this.sessionId,
      assignmentId: data.assignmentId.present
  ...
  @override
  String toString() {
    return (StringBuffer('CartConsumableRecordsData(')
          ..write('sessionId: $sessionId, ')
          ..write('assignmentId: $assignmentId, ')
          ..write('itemId: $itemId, ')
          ..write('title: $title, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is CartConsumableRecordsData &&
          other.sessionId == this.sessionId &&
          other.assignmentId == this.assignmentId &&
...
class CartConsumableRecordsCompanion
    extends UpdateCompanion<CartConsumableRecordsData> {
  final Value<String> sessionId;
  final Value<String> assignmentId;
  ...
  CartConsumableRecordsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       updatedAtMicros = Value(updatedAtMicros),
       lastCommandId = Value(lastCommandId);
  static Insertable<CartConsumableRecordsData> custom({
    Expression<String>? sessionId,
    Expression<String>? assignmentId,
...
class DatabaseAtV9 extends GeneratedDatabase {
  ...
  late final HousekeeperCatalogRecords housekeeperCatalogRecords =
      HousekeeperCatalogRecords(this);
  ...
  late final AssignmentNoteRecords assignmentNoteRecords =
      AssignmentNoteRecords(this);
  late final CartConsumableRecords cartConsumableRecords =
      CartConsumableRecords(this);
