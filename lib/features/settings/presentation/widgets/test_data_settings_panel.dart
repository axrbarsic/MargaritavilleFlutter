  ...
  Future<void> _confirmAndActivate() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Все текущие назначения, статусы, VIP и расписание будут заменены. '
          'Абсолютно все номера текущего каталога будут заново перемешаны и '
          'распределены между уборщицами активной смены.',
        ),
        actions: [
          TextButton(
